...
{ // PURPOSE: Return which appearance the rider should use when mounted
    ...
    { // female
        ...
        else if (nRace==RACIAL_TYPE_DUERGAR) return HORSE_RACE_MOUNTED_DWARFF;
        else if (nRace==RACIAL_TYPE_DROW) return HORSE_RACE_MOUNTED_ELFF;
        else if (nRace==RACIAL_TYPE_SVIRFNEBLIN) return HORSE_RACE_MOUNTED_GNOMEF;
        else if (nRace==RACIAL_TYPE_HALFDROW) return HORSE_RACE_MOUNTED_HALFELFF;
        else if (nRace==RACIAL_TYPE_AASIMAR) return HORSE_RACE_MOUNTED_HUMANF;
        else if (nRace==RACIAL_TYPE_TIEFLING) return HORSE_RACE_MOUNTED_HUMANF;
        else if (nRace==RACIAL_TYPE_GENASI_AIR) return HORSE_RACE_MOUNTED_HUMANF;
        else if (nRace==RACIAL_TYPE_GENASI_EARTH) return HORSE_RACE_MOUNTED_HUMANF;
        else if (nRace==RACIAL_TYPE_GENASI_FIRE) return HORSE_RACE_MOUNTED_HUMANF;
        else if (nRace==RACIAL_TYPE_GENASI_WATER) return HORSE_RACE_MOUNTED_HUMANF;
    } // female
    else
    { // male
        ...
        else if (nRace==RACIAL_TYPE_DUERGAR) return HORSE_RACE_MOUNTED_DWARFM;
        else if (nRace==RACIAL_TYPE_DROW) return HORSE_RACE_MOUNTED_ELFM;
        else if (nRace==RACIAL_TYPE_SVIRFNEBLIN) return HORSE_RACE_MOUNTED_GNOMEM;
        else if (nRace==RACIAL_TYPE_HALFDROW) return HORSE_RACE_MOUNTED_HALFELFM;
        else if (nRace==RACIAL_TYPE_AASIMAR) return HORSE_RACE_MOUNTED_HUMANM;
        else if (nRace==RACIAL_TYPE_TIEFLING) return HORSE_RACE_MOUNTED_HUMANM;
        else if (nRace==RACIAL_TYPE_GENASI_AIR) return HORSE_RACE_MOUNTED_HUMANM;
        else if (nRace==RACIAL_TYPE_GENASI_EARTH) return HORSE_RACE_MOUNTED_HUMANM;
        else if (nRace==RACIAL_TYPE_GENASI_FIRE) return HORSE_RACE_MOUNTED_HUMANM;
        else if (nRace==RACIAL_TYPE_GENASI_WATER) return HORSE_RACE_MOUNTED_HUMANM;
    } // male
...
{ // PURPOSE: This will return the race restriction string to use for oRider
    ...
    { // valid
        ...
        else if (nRace==RACIAL_TYPE_DUERGAR) sRet=sRet+"DWARF";
        else if (nRace==RACIAL_TYPE_DROW) sRet=sRet+"ELF";
        else if (nRace==RACIAL_TYPE_SVIRFNEBLIN) sRet=sRet+"GNOME";
        else if (nRace==RACIAL_TYPE_HALFDROW) sRet=sRet+"HALFELF";
        else if (nRace==RACIAL_TYPE_AASIMAR) sRet=sRet+"HUMAN";
        else if (nRace==RACIAL_TYPE_TIEFLING) sRet=sRet+"HUMAN";
        else if (nRace==RACIAL_TYPE_GENASI_AIR) sRet=sRet+"HUMAN";
        else if (nRace==RACIAL_TYPE_GENASI_EARTH) sRet=sRet+"HUMAN";
        else if (nRace==RACIAL_TYPE_GENASI_FIRE) sRet=sRet+"HUMAN";
        else if (nRace==RACIAL_TYPE_GENASI_WATER) sRet=sRet+"HUMAN";
...
{ // PURPOSE: This will return which appearance should be used to handle animation
    ...
    else if (nRace==RACIAL_TYPE_DUERGAR) return HORSE_NULL_RACE_DWARF;
    else if (nRace==RACIAL_TYPE_DROW) return HORSE_NULL_RACE_ELF;
    else if (nRace==RACIAL_TYPE_SVIRFNEBLIN) return HORSE_NULL_RACE_GNOME;
    else if (nRace==RACIAL_TYPE_HALFDROW) return HORSE_NULL_RACE_HALFELF;
    else if (nRace==RACIAL_TYPE_AASIMAR) return HORSE_NULL_RACE_HUMAN;
    else if (nRace==RACIAL_TYPE_TIEFLING) return HORSE_NULL_RACE_HUMAN;
    else if (nRace==RACIAL_TYPE_GENASI_AIR) return HORSE_NULL_RACE_HUMAN;
    else if (nRace==RACIAL_TYPE_GENASI_EARTH) return HORSE_NULL_RACE_HUMAN;
    else if (nRace==RACIAL_TYPE_GENASI_FIRE) return HORSE_NULL_RACE_HUMAN;
    else if (nRace==RACIAL_TYPE_GENASI_WATER) return HORSE_NULL_RACE_HUMAN;
